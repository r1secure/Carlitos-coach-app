...
import { ArrowLeft, Lightbulb, Calendar, Video as VideoIcon } from 'lucide-react'
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div>
                        ...
                        <div className="flex items-center text-muted-foreground text-sm mb-6">
                            ...
                            Ajouté le {new Date(tip.created_at).toLocaleDateString()}
                        </div>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="capitalize font-medium">{tip.focus_area}</p>
                            </div>

                            {tip.category && (
                                <div className="pt-4 border-t">
                                    <span className="text-sm text-muted-foreground block mb-1">Catégorie</span>
